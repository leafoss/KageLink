...
class DojoTrainingService(_BaseDojoTrainingService):
    """Canonical Kage Pilot Dojo process facade.

    Public integrations depend on this versionless module. Historical engine
    revisions remain Git history and must not become separate public entry
    points again.
    """
