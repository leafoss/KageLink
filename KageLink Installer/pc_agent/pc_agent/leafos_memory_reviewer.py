...
TEXT = {
    "pt-BR": {
        ...
        "menu_folder":"Abrir pasta da Canonical Memory","menu_json":"Abrir memory.json","menu_md":"Abrir MEMORY.md",
        ...
        "cat_lore":"Lore","cat_memories":"Memórias","per_observed":"Observado","per_said":"Dito","per_inferred":"Inferido",
    },
    "en-US": {
...
def main() -> int:
    parser=argparse.ArgumentParser(description="Review LeafOS Interpreter candidates and promote human-approved canonical memory."); parser.add_argument("--vault",required=True); parser.add_argument("--list",action="store_true"); parser.add_argument("--lang",choices=("pt-BR","en-US"),default=None); args=parser.parse_args(); reviewer=LeafOSMemoryReviewer(Path(args.vault))
    if args.list: print(json.dumps(reviewer.list_sessions(),ensure_ascii=False,indent=2,default=str)); return 0
